  ...
  <a-config-provider>
    ...
    <div>
      ...
      <a-collapse
        :bordered="false"
        accordion
        class="reserved-classes-list"
        force-render
        v-model="openedCourseId"
      >
...
/*noinspection CssUnusedSymbol*/
.course >>> .ant-collapse-header:hover .course-name,
.course >>> .ant-collapse-header:hover .course-id,
.course >>> .ant-collapse-header:hover .teacher-name,
.course >>> .ant-collapse-header:hover .teacher-id,
.course >>> .ant-collapse-header:hover .selected-info,
.course >>> .ant-collapse-header:hover .credit-badge,
